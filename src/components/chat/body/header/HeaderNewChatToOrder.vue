<template>
    <div class="chat-body_header_search chat-popup">
        ...
        <button class="chat-button btn-sm main-button margin-r--10" :disabled="!selectedOrder" @click="createChat">Создать чат</button>
        <button class="chat-button btn-sm secondary-button" @click="toggleCreateChatToOrder">Отмена</button>
